...
exports.getUserOnlineStatus = exports.updateOnlineStatus = exports.updateMessageStatus = exports.sendMessage = exports.getChatMessages = exports.getChatRooms = void 0;
...
const getChatRooms = async (req, res) => {
    try {
        ...
        const [rooms] = await database_1.default.execute(`
      SELECT 
        cr.id as room_id,
        cr.participant1_id,
        cr.participant2_id,
...
const getChatMessages = async (req, res) => {
    try {
        ...
        let [rooms] = await database_1.default.execute(`
...
const getUserOnlineStatus = async (req, res) => {
    try {
        ...
        const [status] = await database_1.default.execute(`
    ...
    `, [userId]);
        res.json({
            success: true,
            status: status[0] || { is_online: false, last_seen: null }
        });
    }
    catch (error) {
