...
exports.createTestNotifications = void 0;
...
const createTestNotifications = async () => {
    try {
        ...
        const [userRows] = await database_1.default.execute('SELECT id FROM users LIMIT 1');
        ...
        for (const notification of testNotifications) {
            ...
            await database_1.default.execute(`INSERT INTO notifications 
         (id, user_id, type, title, message, data, is_read, created_at)
         VALUES (?, ?, ?, ?, ?, ?, FALSE, NOW())`, [notificationId, userId, notification.type, notification.title, notification.message, notification.data]);
        }
        ...
        for (const type of notificationTypes) {
            const preferenceId = (0, uuid_1.v4)();
         ...
         in_app_enabled = VALUES(in_app_enabled)`, [preferenceId, userId, type]);
        }
...
if (require.main === module) {
    (0, exports.createTestNotifications)()
        .then(() => {
...
//# sourceMappingURL=createTestNotifications.js.map